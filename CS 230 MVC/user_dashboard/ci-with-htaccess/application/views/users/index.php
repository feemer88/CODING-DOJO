...
<!-- <div class="container"> -->
	...
	<div class='container'>
		<div class="jumbotron">
		  ...
		  <p>We're going to build a cool application using a MVC framework! This application was built with PHP CodeIgniter!</p>
		  <p><a class="btn btn-primary btn-lg" href="/home" role="button">Click here to start!</a></p>
		</div>
		<div class='row'>
			<div class='col-sm-4'>
				<h4>Manage Users</h4>
